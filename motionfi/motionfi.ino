...
char auth[] = "577dd84f28434c9b9a0b8784707ff71c";
...
//      delay(100);
//      counter++;
//      if(counter==retries){ESP.deepSleep(0);}
//
//      // Potentially infinite loops are generally dangerous.
//      // Add delays -- allowing the processor to perform other
//      // tasks -- wherever possible.
...
void configadxl(){
  ...
  adxl.setActivityThreshold(28.6);      // 62.5mg per increment   // Set activity   // Inactivity thresholds (0-255)
